...
## [0.5.0](https://github.com/undef-games/undef-telemetry/compare/undef-telemetry-v0.4.0...undef-telemetry-v0.5.0) (2026-03-29)
...
* add missing H2 heading to polyglot plan doc ([d001e7c](https://github.com/undef-games/undef-telemetry/commit/d001e7cb7bb144710f6fe406cf210fdb0975a437))
* add REUSE annotations for release-please generated files ([e26c441](https://github.com/undef-games/undef-telemetry/commit/e26c441d6f3d577dff5ea37c6ba90f538e8a7e3b))
...
* **ci:** add --ignore-npm-errors to CycloneDX SBOM for TypeScript 6 compat ([33b3d92](https://github.com/undef-games/undef-telemetry/commit/33b3d922719b18c783791e0c60cb9fce2c4fa047))
* **ci:** separate SBOM artifacts from dist to avoid PyPI upload errors ([27d6043](https://github.com/undef-games/undef-telemetry/commit/27d6043976fac438b0cded64b17790ac477e4248))
...
* set VERSION to 0.4.0, update sync script to extract major.minor from any format ([5dd09dc](https://github.com/undef-games/undef-telemetry/commit/5dd09dc154b74e7169e486057b16abd4607b314b))
...
* TS SBOM artifact path, single-worker mutation gate for CI stability ([a1acd12](https://github.com/undef-games/undef-telemetry/commit/a1acd1211ffbc4b3d80742f0c687bcff1cc63216))
* TS SBOM artifact path, single-worker mutation gate for CI stability ([0980f42](https://github.com/undef-games/undef-telemetry/commit/0980f4249246bcacf163a77119227ad3b8aa86a8))
* unify all perf thresholds to 25μs for CI runner tolerance ([c1cb3fc](https://github.com/undef-games/undef-telemetry/commit/c1cb3fc9625b2fe643a306e2839379bdeccafc94))
* validate signal arg in resilience bypass to kill mutation survivors ([4ba5fff](https://github.com/undef-games/undef-telemetry/commit/4ba5fffbb737b8ed1131ab7d647729d821ec2788))
...
* add release-please tag patterns and workflow_dispatch to release workflow ([70aa9e7](https://github.com/undef-games/undef-telemetry/commit/70aa9e7eaa7af29f91f0c2c9f9b4c18940d0541c))
...
* prevent major version bump while pre-1.0 ([5d01a6e](https://github.com/undef-games/undef-telemetry/commit/5d01a6e27303aeeeceb2a35f1945f33bc6aec1fe))
...
* remove review requirement from branch protection (solo dev) ([5d1cafa](https://github.com/undef-games/undef-telemetry/commit/5d1cafac7f6ea3e85662944ab475869cd929afeb))
